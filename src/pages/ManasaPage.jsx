...
export default function ManasaPage() {
  ...
  return (
    <div className="relative min-h-screen bg-mesh font-sans">
      ...
      <AnimatePresence>
        {!envelopeOpen && <EnvelopeScreen monogram="M&J" onOpen={() => setEnvelopeOpen(true)} />}
      </AnimatePresence>
        ...
        {envelopeOpen && (
          ...
          >
            {/*
              ...
              Mrs. Sheeja P.P (W/o. Late Vijayan M.K.)
              Mannatham Poyil, Edakkad, Kozhikode
              cordially invites to the Wedding Ceremony of Dr. Manasa M.P. with Jithindas N.P.
            */}
            <HeroSection
              name1="Dr. Manasa"
              name2="Jithindas"
            ...
            <FamilyHosts
              ...
              quote="Wishes &amp; Compliments from:<br/><span style='font-size:0.65em;opacity:0.9'>Sheeja, Sayooj Vijayan &amp; Vasanthi</span>"
